...
pub use diagnostic::{
    ...
    request_plan, resolve_fuel, service_allowed, DiagnosticExecution, DiagnosticPhase,
    DiagnosticRequest, DiagnosticTransport, FuelClass, RequestExpansion, RequestTarget,
    ServiceGates,
};
